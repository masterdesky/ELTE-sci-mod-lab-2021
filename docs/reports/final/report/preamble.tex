...
\hypersetup{
    ...
    urlcolor=cyan,
    citecolor = cyan,
    pdftitle={ELTE MSc - Modelling Lab - Final Report}
}
...
%\usepackage[skip=2pt, font={small}, justification=centering]{subcaption}
\usepackage[caption=false, font={small}, justification=centering]{subfig}
